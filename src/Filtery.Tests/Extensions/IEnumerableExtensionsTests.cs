...
namespace Filtery.Extensions.Tests
{
    ...
    public class IEnumerableExtensionsTests : TestBase
    {
        ...
        public void BuildFiltery_OrderBy_ASC()
        {
            ...
            //assert
            Assert.AreEqual(response.Data.First().Age, SampleList.OrderBy(p => p.Age).First().Age);
        }
        ...
        public void BuildFiltery_OrderBy_DESC()
        {
            ...
            //assert
            Assert.AreEqual(response.Data.First().Age, SampleList.OrderByDescending(p => p.Age).First().Age);
        }
    }
}